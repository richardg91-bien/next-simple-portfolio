  ...
  <Layout>
    ...
    <header className="row py-4">
      <div className="col-md-12">
        <div className="card card-body bg-info text-dark animate__animated animate__fadeIn">
          <div className="row">
            <div className="col-md-4">
              <img src="/foto richard.jpg" alt="" className="img-fluid" />
            </div>
            <div className="col-md-8">
              <h1>Richard García</h1>
